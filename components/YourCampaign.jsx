...
const FundraisingBanner = () => {
  ...
  return (
    <div className="bg-red-100 w-full md:w-[80%] mx-auto rounded-lg my-4  flex flex-col md:flex-row items-center justify-between p-6 md:p-12">
      <div className="md:w-1/2">
        <h1 className="text-2xl md:text-4xl font-bold mb-4">Raise funds for your cause!</h1>
        <p className="text-md md:text-lg mb-6">
          Onboard on Mandir Project and create impact by raising funds for your initiatives
        </p>
        <div className="flex flex-col md:flex-row">
          <button className="bg-red-500 text-white px-6 py-2 rounded-full mb-2 md:mb-0 md:mr-4"    onClick={handleOpen}>
            Enroll  on Mandir Project
          </button>
